  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        window.open(
          `mailto:dilip.brahmankar@yahoo.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`
        );
        setSubmitted(true);
      }
    } catch {
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', marginBottom: '2.5rem' }}>
                {[
                  ...
                  {
                    label: 'Email',
                    value: 'dilip.brahmankar.@yahoo.com',
                    icon: (
                  ...
                  {
                    label: 'Hours',
                    value: 'Sun - Fri: 10:00 AM - 7:00 PM',
                    icon: (
